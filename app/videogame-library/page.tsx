      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mb-12">
          <div className="flex items-center gap-2 mb-3">
            ...
            <span className="text-cyan-400 text-sm font-semibold uppercase tracking-wider">Database Project</span>
            <span className="w-8 h-px bg-cyan-400" />
          </div>
          <h1 className="text-4xl sm:text-5xl font-bold text-white mb-4">
            Video Game <span style={{ background: 'linear-gradient(135deg,#22d3ee,#22d3ee)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>Library</span>
          </h1>
        ...
        <div className="grid grid-cols-3 gap-4 mb-12">
          {[
            ...
            >
              <p className="text-2xl font-bold" style={{ background: 'linear-gradient(135deg,#22d3ee,#22d3ee)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>{s.value}</p>
