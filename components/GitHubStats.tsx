...
export default function GitHubStats() {
  ...
  const stats = [
    { icon: <BookOpen size={15} className="text-cyan-400" />, label: 'Repositories', value: user?.public_repos ?? '—' },
    ...
    <section className="py-20 px-6 relative">
      <div className="max-w-5xl mx-auto">
        ...
        >
          ...
          <span className="text-cyan-400 text-sm font-semibold uppercase tracking-wider">Open Source</span>
        </motion.div>
          ...
          {stats.map((s) => (
            ...
            >
              ...
              <p
                ...
                style={{ background: 'linear-gradient(135deg,#22d3ee,#22d3ee)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}
              >
                {loaded ? s.value : '…'}
              </p>
