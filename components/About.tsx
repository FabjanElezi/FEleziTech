...
export default function About({ portfolio }: Props) {
  ...
  const chips = [
    { icon: <MapPin size={14} className="text-blue-400" />,      label: location },
    { icon: <GraduationCap size={14} className="text-blue-400" />, label: university },
          ...
          >
            {portfolio?.profileImage ? (
              <Image
                ...
                style={{ border: '2px solid rgba(37,99,235,0.3)', boxShadow: '0 0 32px rgba(37,99,235,0.12)' }}
              />
            ) : (
              <div
