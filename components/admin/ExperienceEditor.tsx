...
const TYPE_STYLE = {
  work:      { bg: 'rgba(37,99,235,0.15)', border: 'rgba(37,99,235,0.35)', text: '#93c5fd', label: 'Work',      icon: Briefcase },
...
export default function ExperienceEditor({ experiences, onChanged }: Props) {
  ...
  return (
    <div>
      ...
      {filter !== 'all' && (
        <p className="text-slate-600 text-xs mb-4">Reorder is available in the <button onClick={() => setFilter('all')} className="text-blue-400 hover:underline">All</button> view.</p>
      )}
